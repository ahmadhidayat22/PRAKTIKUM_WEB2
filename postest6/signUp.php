...
if ( isset($_POST['submit']) ){
        ...
        if(mysqli_fetch_assoc($result)){
          ...
          $sql = "INSERT INTO user_account (id, fullname, username, email, no_hp, `password`,user_type ,picture) VALUES ('', '$fullname', '$username', '$email', '$noHp', '$password','user', 'no-image.jpg')";
